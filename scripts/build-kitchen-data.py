...
stand_mixers = [
    ...
    {"asin":"B000P9CWNY","title":"KitchenAid Pro 600 Series 6-Quart Bowl-Lift Stand Mixer","brand":"KitchenAid","price":549.99,"listPrice":699.99,"rating":4.7,"reviewCount":8000,"specs":{"Bowl Size":"6 qt","Motor":"575W","Speeds":"10","Attachments":"3 included","Warranty":"1 year"},"features":["Bowl-lift design more stable","6-quart capacity for large batches","Powerful 575W motor","All-metal construction","Bread dough up to 8 lbs"]},
]

toasters = [
    {"asin":"B001415B12","title":"Breville BTA840XL Die-Cast 4-Slice Smart Toaster","brand":"Breville","price":179.95,"listPrice":199.99,"rating":4.6,"reviewCount":4500,"specs":{"Slots":"4","Settings":"Digital with LED","Features":"Lift & Look, A Bit More","Material":"Die-cast metal","Warranty":"1 year"},"features":["Motorized Lift & Look","A Bit More button adds time","Die-cast metal construction","LED countdown display","Auto-lowering bread carriage"]},
    {"asin":"B006OQSNYY","title":"Cuisinart Touch to Toast Leverless 4-Slice Toaster","brand":"Cuisinart","price":79.95,"listPrice":99.99,"rating":4.4,"reviewCount":3800,"specs":{"Slots":"4","Settings":"Touchscreen 7 shade","Features":"Bagel, Defrost, Reheat","Material":"Stainless steel","Warranty":"3 years"},"features":["Touchscreen controls","7 shade settings","Bagel/Defrost/Reheat functions","Extra-wide slots for artisan bread","3-year warranty"]},
...
for subcategory, products in kitchen.items():
    for p in products:
        ...
        p["imageUrl"] = f"https://picsum.photos/seed/{p['asin']}/600/600"  # will be overridden by fetch-images scripts
